...
?>
  ...
  <a href="index.php"><img src="images/columbia_logo.gif" alt="movieorama" border="0"
       align="left" valign="bottom" height="150" width="300"/></a>
  </td>
...
function display_movies($movie_array) {
  ...
  if (!is_array($movie_array)) {
    echo "<p>No food currently available in this category</p>";
  } else {
    //create table
...
function display_recommended_movies() {
  ...
  if (!is_array($movie_array)) {
    ...
    echo "<p>Recommended Food:</p>";
    echo "<marquee behavior='scroll'>
            <img src=images/mq.png alt='W3docs' />
          </marquee>";
    //create table
    echo "<table width=\"100%\" border=\"0\">";
    echo "</table>";
...
function display_movie_details($movie) {
  ...
  if (is_array($movie)) {
    ...
    echo "<td><ul>";
    echo "<li><strong>Calories:</strong> ";
    echo $movie['director'];
    echo "</li><li><strong>Item ID:</strong> ";
    echo $movie['movieid'];
